{ stdenv, fetchgit, meson, pkg-config, cmake, glib, gtk4, gtksourceview5, libadwaita, enchant, icu, appimagekit, appstream-glib, pcre, ninja, itstool, libxml2Python, wrapGAppsHook4, python3, gtk3, desktop-file-utils, ... }:
